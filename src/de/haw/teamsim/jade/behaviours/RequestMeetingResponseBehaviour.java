...
public class RequestMeetingResponseBehaviour {
	private static MyJadeAgent agent;
  ...
  private static boolean checkAction() {
	  // calculate whether the receiver will draw its attention to the sender
  ...
  private static boolean performAction(ACLMessage request) {
	  ...
	  try {
		...
		if(obj instanceof AID){
			...
			agent.addBehaviour(MeetingParticipationBehaviour.createBehaviour(agent, MessageTemplate.MatchContent("")));
			return true;
		}
