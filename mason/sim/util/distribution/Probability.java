 ...
 * integral function <tt>incompleteBeta(a, b, x)</tt>.
 *
 * The complemented function is
 *
 * <tt>1 - P(1-x)  =  incompleteBeta( b, a, x )</tt>;
 *
 */
 ...
 * 
 * This function is identical to the incomplete beta
 * integral function <tt>incompleteBeta(b, a, x)</tt>.
 */
    static public double betaComplemented(double a, double b, double x ) {
        return incompleteBeta( b, a, x );
        }
/**
 ...
 * beta integral is employed, according to the formula
 * <p>
 * <tt>y = binomialComplemented( k, n, p ) = incompleteBeta( k+1, n-k, p )</tt>.
 * <p>
 * All arguments must be positive, 
 * @param k end term.
 * @param n the number of trials.
 ...
 */
    static public double binomialComplemented(int k, int n, double p) {
        ...
        return incompleteBeta( k+1, n-k, p );
        }
/**
 ...
 */
    static public double chiSquare(double v, double x) throws ArithmeticException { 
        ...
        return incompleteGamma( v/2.0, x/2.0 );
        }
/**
 * Returns the area under the right hand tail (from <tt>x</tt> to
 ...
 * beta integral is employed, according to the formula
 * <p>
 * <tt>y = negativeBinomial( k, n, p ) = incompleteBeta( n, k+1, p )</tt>.
 *
 * All arguments must be positive, 
 * @param k end term.
 * @param n the number of trials.
 ...
 * beta integral is employed, according to the formula
 * <p>
 * y = negativeBinomialComplemented( k, n, p ) = incompleteBeta( k+1, n, 1-p ).
 *
 * All arguments must be positive, 
 * @param k end term.
 * @param n the number of trials.
 ...
 */
    static public double negativeBinomialComplemented(int k, int n, double p) {
        ...
        return incompleteBeta( k+1, n, 1.0-p );
        }
/**
 ...
 * <p>
 * <tt>y = poisson( k, m ) = incompleteGammaComplement( k+1, m )</tt>.
 *
 * The arguments must both be positive.
 *
 ...
 */
    static public double poisson(int k, double mean) throws ArithmeticException { 
        ...
        if( k < 0 ) return 0.0;
        return incompleteGammaComplement((double)(k+1) ,mean);
        }
/**
 ...
 * <p>
 * <tt>y = poissonComplemented( k, m ) = incompleteGamma( k+1, m )</tt>.
 *
 * The arguments must both be positive.
 *
 * @param k start term.
 ...
 */
    static public double poissonComplemented(int k, double mean) throws ArithmeticException { 
        if( mean < 0 ) throw new IllegalArgumentException();
        if( k < -1 ) return 0.0;
        return incompleteGamma((double)(k+1),mean);
        }
/**
 ...
 * <p>
 * <tt>1 - studentT(k,t) = 0.5 * incompleteBeta( k/2, 1/2, z )</tt>
 ...
 */
    static public double studentT(double k, double t) throws ArithmeticException { 
        ...
        double cdf = 0.5 * incompleteBeta( 0.5*k, 0.5, k / (k + t * t) );
...
/////// MERGED IN BY SEAN FROM stat.Gamma
